...
router_assistant_message = """
    ...
    Your task is to determine if a given user question is related to Microsoft services, such as Azure, Microsoft Cloud, Microsoft Copliot, OpenAPI or any other Microsoft product or service.
